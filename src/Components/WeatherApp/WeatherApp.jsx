...
const WeatherApp = () => {
    ...
    let api_key = "650f8c7a2ba997132e84f399cffd0880";

    const [wicon, setWicon] = useState(cloud_icon);

    const search = async () => {
        const search_bar = document.getElementsByClassName("cityInput");
        ...
        let url = `https://api.openweathermap.org/data/2.5/weather?q=${search_bar[0].value}&units=Imperial&appid=${api_key}`;
        ...
        wind_speed[0].innerHTML = Math.floor(data.wind.speed) + " MPH";
